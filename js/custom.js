$(document).ready(function(){
    ...
    function tab_selection(value) {
        ...
        $("[data-tabs-item]").stop().fadeOut(500);
        $("[data-tabs-item="+value+"]").stop().fadeIn(500);
       
    }


    $(document).on('click', '.b-install-step__image-cont .image_load-icon', function(e){
        var this_slider = $(this).closest(".b-install-step__image-cont").find(".b-install-step__slider"),
            active_elem = this_slider.find(".b-install-step__image.active");


        if (this_slider.find(".b-install-step__image").last().hasClass("active")) {
            this_slider.find(".b-install-step__image").removeClass("active");
            this_slider.find(".b-install-step__image:eq(0)").addClass("active");
        } else {
            this_slider.find(".b-install-step__image").removeClass("active");
    ...
    $(document).on('click', '.tabs__item', function(e){
        ...
        $(this).addClass("active");
        if (this_data == "all") {
            $("[data-tabs-item]").stop().fadeIn(500);
        } else {
            $("[data-tabs-item]").stop().fadeOut(500);
            $("[data-tabs-item="+this_data+"]").stop().fadeIn(500);
        }
